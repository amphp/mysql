...
class PoolTest extends \PHPUnit_Framework_TestCase {
	function testConnect() {
		...
		(new \Amp\NativeReactor)->run(function($reactor) use (&$complete) {
			$db = new \Mysql\Pool("host=".DB_HOST.";user=".DB_USER.";pass=".DB_PASS.";db=connectiontest", null, $reactor);
	...
	function testWrongPassword() {
		...
		(new \Amp\NativeReactor)->run(function($reactor) {
			$db = new \Mysql\Pool("host=".DB_HOST.";user=".DB_USER.";pass=the_wrong_password;db=connectiontest", null, $reactor);
